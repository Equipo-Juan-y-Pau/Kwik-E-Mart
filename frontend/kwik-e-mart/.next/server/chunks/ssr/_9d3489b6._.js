...
const RatingBadge = ({ rating })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
function ProductCard({ producto, onAdd, onSelect }) {
    ...
    const { unit: precioPromo, old: precioOld } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$precio$2d$producto$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTotalPromo"])(producto.promo, producto.price, 1);
...
"[project]/lib/services/reviewService.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$reviewService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/services/reviewService.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function ReviewForm({ productId, onReviewsUpdate }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        /* 1. Llamar al backend */ await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$reviewService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProductReview"])({
            productId,
            username,
            rating,
            comment,
        ...
        /* 2. Refrescar lista */ const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$reviewService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getProductReviews"])().then((r)=>r.reviews);
    ...
    /* ---------- UI ---------- */ return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: !open ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            ...
            children: [
                ...
                (comment.trim() || username.trim()) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function ProductDetailModal({ product, show, onClose, onAdd }) {
    /* ------------------------- estado local ------------------------- */ const [sel, setSel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    /* -------------------- cargar reseñas al abrir ------------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!product || !show) return;
        (async ()=>{
            const all = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$reviewService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getProductReviews"])().then((r)=>r.reviews);
            setReviews(all.filter((rv)=>rv.productId === product.id));
        })();
    }, [
        product,
        show
    ]);
    /* ------------ establecer opciones por defecto al cambio --------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!product) return;
        const defaults = {};
    ...
    /* --------------------------- UX hooks --------------------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useBodyScrollLock$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(show);
    ...
    /* ---------------------- añadir al carrito ----------------------- */ const handleAddToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (!product) return;
    ...
    /* ------------------- calcular precio total ---------------------- */ const { total, old, tag, value } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>product ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$precio$2d$producto$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTotalPromo"])(product.promo, product.price, cantidad) : {
            total: 0,
            old: null,
            tag: null,
            value: null
...
function CatalogoPage() {
    ...
    const { productos, loading: loadingProducts, error: errorProducts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useProductsPromo$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductosPromo"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$routes$292f$productos$2f$data$2f$reviews$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["obtenerReseñas"])().then(setAllReviews).catch(console.error) // Manejo básico de errores de reseñas
    ...
    const averageRatings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
    ...
    // --- Etiquetas y reset ---
    const allTags = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>Array.from(new Set(productos.flatMap((p)=>p.tags))), [
        productos
    ]);
    const reset = ()=>{
        setSearch("");
...
//# sourceMappingURL=_9d3489b6._.js.map