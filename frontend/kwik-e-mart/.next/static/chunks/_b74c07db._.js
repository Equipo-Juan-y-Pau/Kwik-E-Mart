(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_b74c07db._.js", {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UseProductosPromo.useEffect": ()=>{
            ...
            const productosConPromo = rawProductos.map({
                "UseProductosPromo.useEffect.productosConPromo": (prod)=>{
                    // Encuentra la promo relacionada (puede ser varias, pero usamos la primera que aplique)
                    const relPromo = rel.find({
                        "UseProductosPromo.useEffect.productosConPromo.relPromo": (rp)=>rp.idProducto === prod.id
                    }["UseProductosPromo.useEffect.productosConPromo.relPromo"]);
                    const promo = relPromo ? promos.find({
                        "UseProductosPromo.useEffect.productosConPromo": (p)=>p.id === relPromo.idPromo
                    }["UseProductosPromo.useEffect.productosConPromo"]) : undefined;
                    return {
                        ...prod,
                        promo
                    };
                }
            }["UseProductosPromo.useEffect.productosConPromo"]);
            setProductos(productosConPromo);
        }
    }["UseProductosPromo.useEffect"], []);
    return productos;
}
_s(UseProductosPromo, "1DSHZPgX73L4Uszt4d22RALz2sY=");
_c = UseProductosPromo;
const __TURBOPACK__default__export__ = UseProductosPromo;
var _c;
__turbopack_context__.k.register(_c, "UseProductosPromo");
...
function ProductDetailModal({ product, show, onClose, onAdd }) {
    ...
    /* ---------- carga reseñas desde API ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductDetailModal.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchReseñas"])().then({
                "ProductDetailModal.useEffect": (all)=>setReviews(all)
            }["ProductDetailModal.useEffect"]).catch({
                "ProductDetailModal.useEffect": (err)=>console.error("Error fetch reseñas:", err)
            }["ProductDetailModal.useEffect"]);
        }
    }["ProductDetailModal.useEffect"], []);
...
_s(ProductDetailModal, "PweyW4RlZBjU8/gZ+8H36FizaNY=", false, function() {
    return [
...
//# sourceMappingURL=_b74c07db._.js.map