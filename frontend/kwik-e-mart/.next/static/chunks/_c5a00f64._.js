(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_c5a00f64._.js", {

"[project]/components/useProductosPromo.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useProductosConPromo() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useProductosConPromo.useEffect": ()=>{
            let mounted = true;
            Promise.all([
                fetchJSON("/api/productos"),
                fetchJSON("/api/promos"),
                fetchJSON("/api/promo-productos")
            ]).then({
                "useProductosConPromo.useEffect": ([rawProductos, promos, rels])=>{
                    if (!mounted) return;
                    // Asociar cada producto con su promo (la primera que encuentre)
                    const productosConPromo = rawProductos.map({
                        "useProductosConPromo.useEffect.productosConPromo": (prod)=>{
                            const rel = rels.find({
                                "useProductosConPromo.useEffect.productosConPromo.rel": (r)=>r.idProducto === prod.id
                            }["useProductosConPromo.useEffect.productosConPromo.rel"]);
                            const promo = rel ? promos.find({
                                "useProductosConPromo.useEffect.productosConPromo": (p)=>p.id === rel.idPromo
                            }["useProductosConPromo.useEffect.productosConPromo"]) : undefined;
                            return {
                                ...prod,
                                promo
                            };
                        }
                    }["useProductosConPromo.useEffect.productosConPromo"]);
                    setProductos(productosConPromo);
                }
            }["useProductosConPromo.useEffect"]).catch({
                "useProductosConPromo.useEffect": (err)=>{
                    console.error("Error cargando productos/promos:", err);
...
_s(useProductosConPromo, "1DSHZPgX73L4Uszt4d22RALz2sY=");
...
;
;
/** Badge visual para la nota media. */ const RatingBadge = ({ rating })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_c = RatingBadge;
function ProductCard({ producto, onAdd, onSelect, rating }) {
    _s();
    const { unit: precioPromo, old: precioOld } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$precio$2d$producto$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTotalPromo"])(producto.promo, producto.precio, 1);
    ...
    const handleWishlistClick = (e)=>{
        e.stopPropagation();
        isProductInWishlist ? removeFromWishlist(producto.id) : addToWishlist(producto);
    };
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                        ...
                        children: options.map((v)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                children: v
                            }, v, false, {
                                fileName: "[project]/app/(routes)/productos/components/OptionSelect.tsx",
                                lineNumber: 31,
...
function ReviewForm({ onSubmit }) {
    ...
    /* Autofocus cuando se despliega */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    /* ------------- UI ------------- */ return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: !open ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            ...
            children: [
                ...
                (comentario.trim() || nombre.trim()) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ReviewForm, "6r9DHWLM9tUWksa6sZHi0gTWt/M=");
_c = ReviewForm;
var _c;
...
function ProductDetailModal({ product, show, onClose, onAdd }) {
    _s();
    /* -------------------- state & derived -------------------- */ const [sel, setSel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    const [reviews, setReviews] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$routes$292f$productos$2f$data$2f$reviews$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reseñas"]);
    ...
    /* ---------- reset opciones al cambiar de producto ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductDetailModal.useEffect": ()=>{
            if (product?.opciones) {
                const def = {};
                Object.entries(product.opciones).forEach({
                    "ProductDetailModal.useEffect": ([k, v])=>def[k] = String(v[0])
                }["ProductDetailModal.useEffect"]);
                setSel(def);
            } else setSel({});
            setCantidad(1);
    ...
    /* ---------- hooks de UX ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useBodyScrollLock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(show);
    ...
    /* ---------- callbacks ---------- */ const handleAddToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const handleSubmitReview = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProductDetailModal.useCallback[handleSubmitReview]": ({ nombre, comentario, calificacion })=>{
            if (!product) return;
            setReviews({
                "ProductDetailModal.useCallback[handleSubmitReview]": (prev)=>[
                        ...prev,
                        {
                            id: Date.now(),
            ...
            }["ProductDetailModal.useCallback[handleSubmitReview]"]);
            setTimeout({
                "ProductDetailModal.useCallback[handleSubmitReview]": ()=>reviewsEndRef.current?.scrollIntoView({
                        behavior: "smooth"
                    })
            }["ProductDetailModal.useCallback[handleSubmitReview]"], 150);
        }
    }["ProductDetailModal.useCallback[handleSubmitReview]"], [
        product
    ]);
    const filteredReviews = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductDetailModal.useMemo[filteredReviews]": ()=>product ? reviews.filter({
                "ProductDetailModal.useMemo[filteredReviews]": (r)=>r.productoId === product.id
            }["ProductDetailModal.useMemo[filteredReviews]"]) : []
    }["ProductDetailModal.useMemo[filteredReviews]"], [
        product,
        reviews
    ]);
    /* ---------- precio total ---------- */ const { total, old, tag, value } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductDetailModal.useMemo": ()=>product ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$precio$2d$producto$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTotalPromo"])(product.promo, product.precio, cantidad) : {
                total: 0,
                old: null,
                tag: null,
                value: null
...
_s(ProductDetailModal, "bbQ3CVPJYh4FRyBvL8KK1G88og8=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$useProductosPromo$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/useProductosPromo.tsx [app-client] (ecmascript)");
...
/* 👉 array de reseñas para calcular promedios */ var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$routes$292f$productos$2f$data$2f$reviews$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(routes)/productos/data/reviews.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function CatalogoPage() {
    _s();
    const productos = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$useProductosPromo$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CatalogoPage.useEffect": ()=>{
            ({
                "CatalogoPage.useEffect": async ()=>{
                    const reviews = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$routes$292f$productos$2f$data$2f$reviews$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["obtenerReseñas"])();
                    setAllReviews(reviews);
                }
            })["CatalogoPage.useEffect"]();
        }
    }["CatalogoPage.useEffect"], []);
    /* ---------- filtros de UI ---------- */ const [min, setMin] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    /* rango precio inicial */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CatalogoPage.useEffect": ()=>{
            if (productos.length) {
                const precios = productos.map({
                    "CatalogoPage.useEffect.precios": (p)=>p.precio
    ...
    /* ---------- carrito ---------- */ const { addItem } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    /* ---------- filtrado ---------- */ const list = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CatalogoPage.useMemo[list]": ()=>{
            ...
            return productos.filter({
                "CatalogoPage.useMemo[list]": (p)=>{
                    ...
                    /* rating medio */ const reviews = allReviews.filter({
                        "CatalogoPage.useMemo[list].reviews": (r)=>r.productoId === p.id
                    }["CatalogoPage.useMemo[list].reviews"]);
                    const avg = reviews.length ? reviews.reduce({
                        "CatalogoPage.useMemo[list]": (s, r)=>s + r.calificacion
                    }["CatalogoPage.useMemo[list]"], 0) / reviews.length : 0;
    ...
    /* etiquetas únicas */ const allTags = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CatalogoPage.useMemo[allTags]": ()=>Array.from(new Set(productos.flatMap({
                "CatalogoPage.useMemo[allTags]": (p)=>p.etiquetas
...
_s(CatalogoPage, "uSSulrPaRCNp6VIQSRx7azlbI8Y=", false, function() {
    return [
...
//# sourceMappingURL=_c5a00f64._.js.map