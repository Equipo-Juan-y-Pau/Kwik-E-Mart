(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_1abd4451._.js", {
...
function ProductDetailPage() {
    ...
    const productoEncontrado = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductDetailPage.useMemo[productoEncontrado]": ()=>{
            if (loading || !slug) return null;
            return productos.find({
                "ProductDetailPage.useMemo[productoEncontrado]": (p)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["slugify"])(p.name) === slug
            }["ProductDetailPage.useMemo[productoEncontrado]"]);
        }
    }["ProductDetailPage.useMemo[productoEncontrado]"], [
        productos,
        ...
        "ProductDetailPage.useEffect": ()=>{
            if (productoEncontrado?.options) {
                ...
                Object.entries(productoEncontrado.options).forEach({
                    "ProductDetailPage.useEffect": ([key, valueArray])=>{
...
_s(ProductDetailPage, "dAuPHsuxcEScc1ByPtQJ+b9l1PE=", false, function() {
    return [
...
//# sourceMappingURL=_1abd4451._.js.map