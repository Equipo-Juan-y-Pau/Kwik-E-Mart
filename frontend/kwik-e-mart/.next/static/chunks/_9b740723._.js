(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_9b740723._.js", {
 ...
 *  AdminSidebar
 *  ------------------------------------------------------------------------
 *  Sidebar “ilustrado” fijo para escritorio (≥ sm).
 *  El arte de Apu está dividido en tres capas:
 *    1.  Techo           (altura fija ROOF_H)
 *    2.  Cuerpo enlaces  (scroll interno)
 *    3.  Pies            (FEET_H)
 *  Al hacer scroll el div de enlaces crece/encoge — se calcula el corte
 *  (cutPx) restando la posición de la línea de las manos de Apu.
...
;
;
/* ---- Constantes visuales (tamaño / color) -------------------------------- */ const ROOF_H = 160; // Techo del sidebar
const FOOTER_H = 64; // Footer global, para ajustar altura
const WALL = '#e9d29a';
const WALL_DARK = '#c6b282';
const SIDEBAR_W = '15rem';
const HANDS_LINE_OFFSET = 115; // Línea donde “cortan” las manos de Apu
const FEET_H = 210;
const HEADROOM = 80; // Espacio entre techo y cartel
const sections = [
    {
...
function AdminSidebar() {
    ...
    /* ---- refs para medir el corte de la ilustración --------------------- */ const asideRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const signRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [cutPx, setCutPx] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0); // px a restar al bloque scrollable
    /* Re-calcular en resize */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminSidebar.useEffect": ()=>{
            const updateCut = {
                "AdminSidebar.useEffect.updateCut": ()=>{
                    if (!asideRef.current || !signRef.current) return;
                    const { top: asideTop } = asideRef.current.getBoundingClientRect();
                    const { bottom: signBot } = signRef.current.getBoundingClientRect();
                    const rawCut = signBot - asideTop;
                    setCutPx(Math.max(0, Math.round(rawCut - HANDS_LINE_OFFSET)));
                }
            }["AdminSidebar.useEffect.updateCut"];
            updateCut();
            window.addEventListener('resize', updateCut);
            return ({
                "AdminSidebar.useEffect": ()=>window.removeEventListener('resize', updateCut)
            })["AdminSidebar.useEffect"];
        }
    }["AdminSidebar.useEffect"], []);
    /* -------------------------------------------------------------------- */ /*                                 JSX                                  */ /* -------------------------------------------------------------------- */ return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
        ref: asideRef,
        className: "fixed bottom-0 left-4 z-20 flex flex-col justify-end text-[#031926] font-bold",
        style: {
            top: ROOF_H,
            width: SIDEBAR_W,
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                        src: "/images/apusidebar.png",
                        alt: "Apu sosteniendo el menú",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                style: {
                    height: `calc(100% - ${cutPx + HEADROOM}px - ${FEET_H}px)`,
                    backgroundColor: WALL_DARK,
                    boxShadow: '0 4px 12px rgba(0,0,0,0.25)'
                },
                children: sections.map(({ title, items })=>{
                    const expanded = items.some((it)=>pathname.startsWith(it.href));
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "group mt-6",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "cursor-pointer px-6 pb-2 text-xs uppercase text-gray-900",
                                children: title
                            }, void 0, false, {
                                fileName: "[project]/components/admin/sidebar.tsx",
                                lineNumber: 141,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('overflow-hidden transition-all duration-500 ease-out', expanded ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0', 'group-hover:max-h-32 group-hover:opacity-100'),
                                children: items.map(({ href, label, icon: Icon })=>{
                                    const active = pathname.startsWith(href);
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        href: href,
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('flex items-center gap-3 px-6 py-3 rounded-r-md transition', active ? 'brightness-110' : 'hover:bg-opacity-10'),
                                        style: {
                                            backgroundColor: active ? WALL : 'transparent'
                                        },
                                        children: [
...
_s(AdminSidebar, "JOcBWdaqhI2tiaGlAfxQZ7v0egA=", false, function() {
    return [
...
// ————————————————————————————————————————————————
// Sidebar móvil para la sección de administración.
// Se muestra únicamente en pantallas pequeñas (< sm) y
// ofrece accesos rápidos a las vistas de administración.
//
// Estructura general:
// 1. contenedor a pantalla completa con fondo beige
// 2. botón de cierre en la parte superior derecha
// 3. navegación dividida por secciones
//
// Props
// ───────────────────────────────────────────────
// • onClose(): callback que proviene del layout padre
//   para cerrar el menú (se invoca al pulsar el botón
//   × o al hacer click en cualquier enlace).
//
// Notas
// ───────────────────────────────────────────────
// • Lucide-react se usa para los iconos.
// • Las rutas coinciden con las secciones definidas en el
//   sidebar de escritorio; si añades una nueva ruta ahí,
//   recuerda añadirla también aquí.
// • bg-[#e9d29a] = color de pared característico del
//   Kwik-E-Mart.
// ————————————————————————————————————————————————
__turbopack_context__.s({
...
function MobileSidebar({ onClose }) {
    return(// Contenedor a pantalla completa (posición fija)
    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "fixed inset-0 z-50 bg-[#e9d29a] overflow-auto",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            href: "/admin/visualizar",
                                            onClick: onClose,
                                            className: "flex items-center space-x-3 rounded-lg px-3 py-2 hover:bg-[#e0c986] transition",
                                            children: [
 ...
 * **AdminLayout**
 *
 * Layout raíz para todas las rutas `/admin/*`.
 *
 * ── Estructura ────────────────────────────────────────────────────────
 *  • Sidebar fijo (>= sm)          – `AdminSidebar`
 *  • Header + hamburger (xs)       – Logo + User + botón toggle
 *  • Sidebar deslizable (xs)       – `MobileSidebar`
 *  • `main` responsive             
 *
...
function AdminLayout({ children }) {
    _s();
    /* -------------------------------------------------------------------- */ /*                             Estado móvil                             */ /* -------------------------------------------------------------------- */ const [mobileOpen, setMobileOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    /* -------------------------------------------------------------------- */ /*                                JSX                                   */ /* -------------------------------------------------------------------- */ return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                className: "fixed inset-x-0 top-0 z-50 flex h-16 items-center justify-between bg-[#e9d29a] px-4 sm:hidden",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            mobileOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$admin$2f$mobile$2d$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                className: "   flex-1 overflow-auto bg-[#e9d29a] text-gray-900   pt-[64px]                 sm:pt-[50px]               sm:pl-[15rem]              ",
                children: children
            }, void 0, false, {
                fileName: "[project]/app/admin/layout.tsx",
                lineNumber: 63,
...
_s(AdminLayout, "33pz4tKGxA4/1e2zOoGo8gBQzP0=");
_c = AdminLayout;
var _c;
...
//# sourceMappingURL=_9b740723._.js.map